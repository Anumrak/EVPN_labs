...
4) Настроить опцию изменения атрибута next-hop на Spine роутерах для своих Leaf соседей.
...
8) Проверить RIB на Leaf_1 роутере как примерном на наличие всех Loopback адресов, полученных от Spine_1 и Spine_2.
