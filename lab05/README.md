...
Второй маршрут, также типом 2 mac-ip, но уже несет в себе и IP адрес хоста во vlan id 100, но выучен он уже благодаря функционалу arp suppression
...
* e[3]:[0]:[32]:[10.0.0.2]/88
```
### Првоерка MAC таблицы Leaf роутера
```
...
### Првоерка arp suppression таблицы
```
...
![vxlan icmp](https://github.com/Anumrak/EVPN_labs/assets/133969023/3a24013e-6550-48c7-a1ef-5e411db11e9c)
